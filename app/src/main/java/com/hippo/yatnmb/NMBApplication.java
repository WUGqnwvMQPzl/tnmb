...
import com.hippo.yatnmb.client.NMBDns;
import com.hippo.yatnmb.client.NMBInterceptor;
import com.hippo.yatnmb.client.NMBRequest;
import com.hippo.yatnmb.client.ac.data.ACCdnPath;
import com.hippo.yatnmb.client.ac.data.ACForum;
import com.hippo.yatnmb.client.ac.data.ACForumGroup;
import com.hippo.yatnmb.client.data.ACSite;
import com.hippo.yatnmb.network.HttpCookieDB;
import com.hippo.yatnmb.network.HttpCookieWithId;
import com.hippo.yatnmb.network.SimpleCookieStore;
import com.hippo.yatnmb.ui.BringToForegroundActivity;
...
import com.hippo.yatnmb.util.ResImageGetter;
import com.hippo.yatnmb.util.Settings;
import com.hippo.yatnmb.widget.ImageWrapperHelper;
...
public final class NMBApplication extends Application
    ...
    public void bringActivitiesToForeground() {
        ...
        while (--i >= 0) {
            ...
            if (activity != null && !"com.hippo.yatnmb.wxapi.WXEntryActivity".equals(activity.getClass().getName())) {
