...
package com.hippo.yatnmb.daogenerator;
...
public class NMBDaoGenerator {
    ...
    private static final String PACKAGE = "com.hippo.yatnmb.dao";
    private static final String OUT_DIR = "../app/src/main/java-gen";
    private static final String DELETE_DIR = "../app/src/main/java-gen/com/hippo/yatnmb/dao";
